...
func (m *ResponseHeader) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.RaftLeaderId != 0 {
		i = protohelpers.EncodeVarint(dAtA, i, uint64(m.RaftLeaderId))
		i--
		dAtA[i] = 0x28
	}
	if m.RaftTerm != 0 {
...
func (m *ResponseHeader) SizeVT() (n int) {
	...
	if m.RaftLeaderId != 0 {
		n += 1 + protohelpers.SizeOfVarint(uint64(m.RaftLeaderId))
	}
...
func (m *Member) UnmarshalVTUnsafe(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			m.PeerURLs = append(m.PeerURLs, stringValue)
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ClientURLs", wireType)
			...
			m.ClientURLs = append(m.ClientURLs, stringValue)
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := protohelpers.Skip(dAtA[iNdEx:])
...
func (m *StatusResponse) UnmarshalVTUnsafe(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			...
			if err := (*structpb.Struct)(m.Config).UnmarshalVTUnsafe(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 8:
