...
func (m *Command) UnmarshalVTUnsafe(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			if err := m.Kv.UnmarshalVTUnsafe(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 5:
		...
		case 6:
			...
			if err := m.Batch[len(m.Batch)-1].UnmarshalVTUnsafe(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 7:
			...
			if err := m.Txn.UnmarshalVTUnsafe(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 8:
			...
			m.RangeEnd = dAtA[iNdEx:postIndex]
			iNdEx = postIndex
		case 9:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field PrevKvs", wireType)
		...
		case 10:
			...
			if err := m.Sequence[len(m.Sequence)-1].UnmarshalVTUnsafe(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 11:
...
func (m *Txn) UnmarshalVTUnsafe(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Compare = append(m.Compare, &Compare{})
			if err := m.Compare[len(m.Compare)-1].UnmarshalVTUnsafe(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 2:
			...
			m.Success = append(m.Success, &RequestOp{})
			if err := m.Success[len(m.Success)-1].UnmarshalVTUnsafe(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 3:
			...
			m.Failure = append(m.Failure, &RequestOp{})
			if err := m.Failure[len(m.Failure)-1].UnmarshalVTUnsafe(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *RequestOp) UnmarshalVTUnsafe(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if oneof, ok := m.Request.(*RequestOp_RequestRange); ok {
				if err := oneof.RequestRange.UnmarshalVTUnsafe(dAtA[iNdEx:postIndex]); err != nil {
					return err
				}
			} else {
				v := &RequestOp_Range{}
		...
		case 2:
			...
			if oneof, ok := m.Request.(*RequestOp_RequestPut); ok {
				if err := oneof.RequestPut.UnmarshalVTUnsafe(dAtA[iNdEx:postIndex]); err != nil {
					return err
				}
			} else {
				v := &RequestOp_Put{}
		...
		case 3:
			...
			if oneof, ok := m.Request.(*RequestOp_RequestDeleteRange); ok {
				if err := oneof.RequestDeleteRange.UnmarshalVTUnsafe(dAtA[iNdEx:postIndex]); err != nil {
					return err
				}
			} else {
				v := &RequestOp_DeleteRange{}
...
func (m *ResponseOp_Range) UnmarshalVTUnsafe(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Kvs = append(m.Kvs, &KeyValue{})
			if err := m.Kvs[len(m.Kvs)-1].UnmarshalVTUnsafe(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 2:
...
func (m *ResponseOp_Put) UnmarshalVTUnsafe(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if err := m.PrevKv.UnmarshalVTUnsafe(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *ResponseOp_DeleteRange) UnmarshalVTUnsafe(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.PrevKvs = append(m.PrevKvs, &KeyValue{})
			if err := m.PrevKvs[len(m.PrevKvs)-1].UnmarshalVTUnsafe(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *ResponseOp) UnmarshalVTUnsafe(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if oneof, ok := m.Response.(*ResponseOp_ResponseRange); ok {
				if err := oneof.ResponseRange.UnmarshalVTUnsafe(dAtA[iNdEx:postIndex]); err != nil {
					return err
				}
			} else {
				v := &ResponseOp_Range{}
		...
		case 2:
			...
			if oneof, ok := m.Response.(*ResponseOp_ResponsePut); ok {
				if err := oneof.ResponsePut.UnmarshalVTUnsafe(dAtA[iNdEx:postIndex]); err != nil {
					return err
				}
			} else {
				v := &ResponseOp_Put{}
		...
		case 3:
			...
			if oneof, ok := m.Response.(*ResponseOp_ResponseDeleteRange); ok {
				if err := oneof.ResponseDeleteRange.UnmarshalVTUnsafe(dAtA[iNdEx:postIndex]); err != nil {
					return err
				}
			} else {
				v := &ResponseOp_DeleteRange{}
